...
public static class PositionExtensions
{
    ...
    /// <returns></returns>
    public static (int Col, int Row) ToCell(this Position pos) => ((int)MathF.Round(pos.X), (int)MathF.Round(pos.Y));
    ...
    public static Position ToPosition(this Vector2 vector) => new(vector.X, vector.Y);
}
